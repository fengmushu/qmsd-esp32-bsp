...
{
    gpio_hal_iomux_func_sel(GPIO_PIN_MUX_REG[config->pin_num_wr], PIN_FUNC_GPIO);
...
static esp_err_t lcd_dma_config(lcd_cam_obj_t *lcd_cam_obj, const i2s_lcd_config_t *config)
{
    ...
    ESP_LOGI(TAG, "lcd_buffer_size: %" PRIo32 ", lcd_dma_size: %" PRIo32 ", lcd_dma_node_cnt: %" PRIo32, lcd_cam_obj->dma_buffer_size, lcd_cam_obj->dma_node_buffer_size, lcd_cam_obj->dma_node_cnt);
